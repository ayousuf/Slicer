...
class ChartStorage:
  def __init__(self, parent):
    parent.title = "ChartStorage" # TODO make this more human readable by adding spaces
    parent.categories = ["Testing.TestCases"]
    parent.dependencies = []
    parent.contributors = ["Aisha Yousuf (GE)"] # replace with "Firstname Lastname (Org)"
    parent.helpText = """
    Module to test Chart Storage.
    """
    parent.acknowledgementText = """
    This file was originally developed by Aisha Yousuf, GE and was partially funded by NIH grant U54EB005149.
""" 
    ...
    try:
      ...
      slicer.selfTests = {}
    slicer.selfTests['ChartStorage'] = self.runTest
    #
  def runTest(self):
...
class ChartStorageWidget:
  ...
  def setup(self):
    ...
    self.reloadButton.name = "ChartStorage Reload"
  ...
  def onReload(self,moduleName="ChartStorage"):
...
class ChartStorageTest(unittest.TestCase):
  """
